...
const Admin: NextPage = () => {
  ...
  const offer = {
    ...
    "poolurl": "https://beets.fi/pool/0x5e02ab5699549675a6d3beeb92a62782712d0509000200000000000000000138",
      ...
      <>
        ...
        <Card m={6}>
          ...
          <CardBody>
            <Box>
              <HStack gap={4}>
                <Button onClick={() => addToken.mutate({ round, payload: token })}>Add token</Button>
                <Button onClick={() => editToken.mutate({ round, payload: token })}>Edit token</Button>
                <Button onClick={() => deleteToken.mutate({ round, tokenId: 1 })}>Delete token</Button>
              </HStack>
            </Box>
          </CardBody>
        </Card>
        ...
        <Card m={6}>
          ...
          <CardBody>
            <Box>
              <HStack gap={4}>
                <Button onClick={() => addOffer.mutate({ round, payload: offer })}>Add offer</Button>
                <Button onClick={() => editOffer.mutate({ round, payload: offer })}>Edit offer</Button>
                <Button onClick={() => deleteOffer.mutate({ round, offerId: 1 })}>Delete offer</Button>
              </HStack>
            </Box>
          </CardBody>
        </Card>
        ...
        <Card m={6}>
          ...
          <CardBody>
            <Box>
              <HStack gap={4}>
                <Button onClick={() => addReward.mutate({ payload: reward, round, offer: 1 })}>Add reward</Button>
                <Button onClick={() => editReward.mutate({ payload: reward, round, offer: 1 })}>Edit reward</Button>
                <Button onClick={() => deleteReward.mutate({ round, offer: 1, reward: 2 })}>Delete reward</Button>
              </HStack>
            </Box>
          </CardBody>
        </Card>
