...
import { getSnapshotVotesPerPool } from "utils/externalData/snapshot"; // getSnapshotProposal
// import { getRelicLevelInfo } from "utils/externalData/theGraph"; //getBlockByTsGraph
